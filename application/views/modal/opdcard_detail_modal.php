        ...
        <table style="border-collapse: collapse;width: 100%;">
          <tr>
            <td width="27%" style="text-align: left;">
              <p> ชื่อ : <?php echo $customer->customer_prefix . ' ' . $customer->customer_fname . '  ' . $customer->customer_lname; ?></p>
            </td>
            <?php
            ...
            <td width="9%" style="text-align: left;">
              <p><?php echo 'เพศ : ' . $customer->customer_gender; ?></p>
            </td>
            <td width="30%" style="text-align: left;">
              <p><?php echo $age . '&nbsp;&nbsp;&nbsp;' . 'กรุ๊ปเลือด' . ' : ' . $customer->customer_blood; ?></p>
            </td>
            <td width="34%" style="text-align: right;">
              <p><?php echo 'สถานพยาบาล : ' . $shop->shop_name; ?></p>
            </td>
          </tr>
          <tr>
            <td width="27%" style="text-align: left;">
              <p><?php echo 'เลขบัตรประชาชน : '; ?><?php echo $customer->customer_idcard != null ? $customer->customer_idcard : ' '; ?></p>
            </td>
            <td colspan="2" style="text-align: left;">
              <p><?php echo 'ที่อยู่ : ' . $customer->customer_address . ' ' . $customer->customer_district . ' ' . $customer->customer_amphoe . ' ' . $customer->customer_province . ' ' . $customer->customer_zipcode; ?></p>
            </td>
            <td width="34%" style="text-align: right;">
              <p><?php echo 'ลักษณะการให้บริการ : ' . $shop->shop_nature; ?></p>
            </td>
          </tr>
          <tr>
            <td width="27%" style="text-align: left;">
              <p><?php echo 'เบอร์โทรผู้ป่วย : '; ?><?php echo $customer->customer_tel != null ? $customer->customer_tel : ' '; ?></p>
            </td>
            <td colspan="2" style="text-align: left;">
              <p><?php echo 'โรคประจำตัว : '; ?><?php echo $customer->customer_disease != null ? $customer->customer_disease : 'ไม่มีประวัติ'; ?></p>
            </td>
            <td width="34%" style="text-align: right;">
              <p><?php echo 'เลขที่ใบอนุญาต : ' . $shop->shop_license; ?></p>
            </td>
          </tr>
          <tr>
            <td colspan="2" style="text-align: left;">
              <p><?php echo 'แพ้ยา : '; ?><?php echo $customer->customer_allergic != null ? $customer->customer_allergic : 'ไม่มีประวัติการแพ้ยา'; ?></p>
            </td>
            <td style="text-align: right;" colspan="2">
              <p><?php echo 'ที่อยู่สถานพยาบาล : ' . $shop->shop_address . ' ' . $shop->shop_district . ' ' . $shop->shop_amphoe . ' ' . $shop->shop_province . ' ' . $shop->shop_zipcode . ' ' . 'โทร ' . $shop->shop_tel; ?></p>
            </td>
          </tr>
        </table>
