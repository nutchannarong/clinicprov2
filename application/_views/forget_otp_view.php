                ...
                <div class="col-md-5 mt-2 d-flex">
                    <div class="card flex-grow-1 mb-md-0 mr-0 mr-lg-3 ml-0 ml-lg-4">
                        <div class="card-body card-body--padding--2">
                            ...
                            <form class="account-menu__form" id="form-otp" method="post" action="<?php echo base_url() . 'forget/dootp'; ?>" autocomplete="off">
                                ...
                                <div class="form-group mb-0">
                                    <button type="submit" class="btn btn-block text-white btn-circle" style="background: #1A79FF;"> ลืมรหัสผ่าน</button>
                                </div>
                                <hr>
...
<script>
    ...
    function sendOtp() {
        $.ajax({
            url: service_base_url + 'forget/sendotp',
            type: 'POST',
            dataType: "JSON",
            data: {
                tel: '<?php echo $tel; ?>'
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    location.href = service_base_url + 'forget';
                }
            }
        });
    }
