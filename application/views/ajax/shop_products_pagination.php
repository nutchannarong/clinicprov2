        ...
        <div class="col-md-6 col-lg-6 col-xl-6 mt-3">
           <div class="card">
               <div class="row">
                   ...
                   <div class="col-8 p-1">
                       <a class="mt-2 text-primary" target="blank_" href="<?php echo base_url().'promotion/'.$row->product_slug; ?>" style="font-size: 16px;"> <?php echo (strlen($row->product_name) > 50 ) ? mb_substr($row->product_name, 0, 50, 'UTF-8') . '...' : $row->product_name; ?></a>
                       <div class="row pr-3">
