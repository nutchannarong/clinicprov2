                ...
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-12 col-xl-3 d-flex">
                            <?php //$this->load->view('layout/navbar-account', array('navacc' => 'order')); 
                            ?>
                        </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-7 col-lg-6 text-right">
            <div class="input-group">
              ...
              <button type="button" class="btn btn-sm btn-primary" onclick="ajaxPagination()"><i class="fa fa-search me-2"></i> ค้นหา</button>
            </div>
          </div>
        </div>
        <div class="row">
...
<div id="result-modal-review" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
...
<script>
  ...
  function ajaxPagination() {
    ...
    $.ajax({
      url: service_base_url + 'order/ajaxpagination',
      type: 'POST',
      data: {
  ...
  //    function modalReview(od_id) {
  //        $('.modal-content').html('')
  //        $.ajax({
  //            url: service_base_url + 'order/modalreview',
  //            type: 'POST',
  //            data: {
  //                od_id: od_id,
  //            },
  //            success: function (response) {
  //                $('#result-modal-review .modal-content').html(response)
  //                $('#result-modal-review').modal('show', {backdrop: 'true'})
  //            }
  //        })
  //    }
</script>
