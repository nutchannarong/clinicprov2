<form id="form-modal" method="post" action="#" onsubmit="return false" autocomplete="off">
  ...
  <div class="modal-body">
    <div class="form-group mb-3">
      ...
      <input type="text" name="tel" class="form-control form-control-md" value="<?php echo $data->online_tel; ?>" readonly>
    </div>
    <div class="form-group mb-3">
      <label class="form-label">รหัสผ่านเดิม</label>
      <input type="password" id="password_old" name="password_old" class="form-control form-control-md" required>
    </div>
    <div class="form-group mb-3">
    ...
    <div class="form-group mb-3">
      ...
      <input type="password" id="password_confirm" name="password_confirm" class="form-control form-control-md" onchange="checkPassword()" required>
    </div>
  </div>
  <div class="modal-footer">
    <button type="button" id="btn-form-modal" class="btn btn-primary"> ตกลง</button>
